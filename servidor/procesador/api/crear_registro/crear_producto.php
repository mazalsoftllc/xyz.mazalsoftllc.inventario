 ...
 if(isset($_POST['add_product'])){
   ...
   if(empty($errors)){
     ...
     if($db->query($query)){
       ...
       redirect('crear_producto.php', false);
     } else {
       $session->msg('d',' Falló el registro del producto.');
       redirect('../leer_coleccion/producto.php', false);
     }
  ...
  <div class="col-md-8">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
         <div class="col-md-12">
          <form method="post" action="crear_producto.php" class="clearfix">
              <div class="form-group">
                <div class="input-group">
                  <span class="input-group-addon">
                   <i class="glyphicon glyphicon-th-large"></i>
                  </span>
                  <input type="text" class="form-control" name="product-title" placeholder="Título del producto">
               </div>
              </div>
              <div class="form-group">
                <div class="row">
