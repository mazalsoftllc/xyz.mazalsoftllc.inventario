...
<?php
  ...
  if($photo->process_user($user_id)){
    $session->msg('s','Fotografía actualizada con éxito.');
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          <div class="panel-heading clearfix">
            ...
            <span>Cambiar mi fotografía</span>
          </div>
        </div>
        <div class="panel-body">
          <div class="row">
            <div class="col-md-4">
                <img class="img-circle img-size-2" src="<?php echo ROUTE_SERVER_HOST;?>servidor/memoria/persistente/almacenamiento-usuario/imagenes/<?php echo $user['image'];?>" alt="">
            </div>
            <div class="col-md-8">
